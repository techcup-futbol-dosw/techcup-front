...
import { loadMatchesIntoCache, loadStandingsIntoCache } from "@/modules/competition/services/competitionsService";
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                    ...
                    <Link to="/player-search">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p style={{ fontSize: "0.75rem", color: P.default }}>
                                    Encuentra compañeros para tu equipo
                                </p>
                            </div>
                        </motion.div>
                    </Link>
                    ...
                    <Link to="/pending-invitations">
                        ...
                        >
                            ...
                            {unreadCount > 0 && (
                                <span
                                    className="absolute top-2 right-2 text-[10px] px-1.5 py-0.5 rounded-full text-white"
                                    style={{ backgroundColor: P.primary, fontWeight: 700 }}
                                >
          {unreadCount}
        </span>
